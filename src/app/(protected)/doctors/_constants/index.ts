// constantes para as especialidades de saúde (médicas e não médicas)
...
export enum MedicalSpecialty {
  ...
  EDUCACAO_FISICA = "Educação Física (Saúde)",
  ENFERMAGEM = "Enfermagem",
  FARMACIA = "Farmácia",
  BIOMEDICINA = "Biomedicina",
  ASSISTENCIA_SOCIAL = "Assistência Social (Saúde)",
...
// enum para as especialidades médicas
